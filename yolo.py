...
class YOLO(object):
    def __init__(self):
        self.model_path = '/content/VV/model_data/yolo4.h5'
        self.anchors_path = '/content/VV/model_data/yolo_anchors.txt'
        self.classes_path = '/content/VV/model_data/coco_classes.txt'
        self.gpu_num = 1
        self.score = 0.5
        self.iou = 0.5
    ...
    def detect_image(self, image):
        ...
        for i, c in reversed(list(enumerate(out_classes))):
            ...
            if predicted_class not in required_classes_from_yolo:  # Modify to detect other classes.
                continue
            box = out_boxes[i]
            score = out_scores[i]
            x = int(box[1])
