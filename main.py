...
class App:
    ...
    def __init__(self):
        ...
        self.model_filename = '/content/VV/model_data/mars-small128.pb'
        ...
        self.filename = "/content/VV/dattatraya"
        self.extension = ".mp4"
    ...
    def viewCam(self):
        ...
        while True: 
            ...
            boxes, confidence, classes = self.yolo.detect_image(Image.fromarray(frame))
